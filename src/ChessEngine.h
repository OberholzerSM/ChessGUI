...
namespace Chess
{
    ...
    constexpr int KingMiddlePST[8][8] =
    {
        {-20,-10,-10,-5,-5,-10,-10,-20},
        {-10,0,0,0,0,0,0,-10},
        {-10,0,5,5,5,5,0,-10},
    ...
    //Piece-Values
    constexpr int pieceValue[6] = {20000,900,330,320,500,100};
}
